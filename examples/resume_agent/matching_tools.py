"""
Tools for resume-JD matching and analysis.

This module contains functions for comparing resumes with job descriptions,
highlighting keywords, and ranking project experience.
"""

import re
from typing import List, Dict, Tuple, Set
from resume_models import Resume, JobDescription, MatchResult, Project
import difflib
...
def calculate_keyword_similarity(keyword1: str, keyword2: str) -> float:
    """Calculate similarity between two keywords using string matching."""
    # Direct match
    ...
    similarity = difflib.SequenceMatcher(None, keyword1.lower(), keyword2.lower()).ratio()
